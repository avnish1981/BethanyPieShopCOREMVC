...
{
    public partial class SeekDataAdded : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Pies",
                columns: new[] { "PieId", "AlleryInformation", "CategoryId", "ImageThumbnailUrl", "ImageUrl", "IsPieOfWeek", "IsPieStock", "LongDescription", "Name", "Price", "ShortDescription" },
                values: new object[,]
                {
